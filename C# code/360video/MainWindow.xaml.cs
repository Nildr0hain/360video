...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            Point handLeft = new Point(skeleton.Joints[JointType.HandLeft].Position.X, skeleton.Joints[JointType.HandLeft].Position.Y);
            Point handRight = new Point(skeleton.Joints[JointType.HandRight].Position.X, skeleton.Joints[JointType.HandRight].Position.Y);
            Point hipCenter = new Point(skeleton.Joints[JointType.HipCenter].Position.X, skeleton.Joints[JointType.HipCenter].Position.Y);
            Thread t1 = new Thread(delegate()
            {
                SSHChar("R", drawingContext);
            });
            Thread t2 = new Thread(delegate()
            {
                SSHChar("L", drawingContext);  
            });
            Thread t3 = new Thread(delegate()
            {
                SSHChar("M", drawingContext);
            });
      ...
      /*  private void TelnetChar(string charToSend,  DrawingContext drawingContext) {
        ...
        /// Telnet connection
        /// </summary>
        private void SSHChar(string charToSend, DrawingContext drawingContext)
        {
